var app =angular.module("principalReview",[]);
app.controller("principalReviewController",['$scope','getAppraisalDatas','submitAppraisals',function($scope,getAppraisalDatas,submitAppraisals){
...
app.factory("getAppraisalDatas",['$http',function($http){
    ...
    Datas=$http({
      method: 'GET',
      url: '/appraisalform/getReviewData'
